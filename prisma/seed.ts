...
const blocks: BlockSeed[] = [
  {
    ...
    perguntas: [
      ...
      { texto: "Qual sistema de integração?", tipo: "TEXTO_CURTO", obrigatoria: false, ordem: 7, repetivel: false, opcoes: [] },
  ...
  },
  {
    ...
    perguntas: [
      ...
      { texto: "Valor", tipo: "TEXTO_CURTO", obrigatoria: true, ordem: 3, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { texto: "O que está incluso", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 4, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { texto: "O que NÃO está incluso", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 5, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { texto: "Descreva o que a empresa faz, qual solução oferece e que tipo de produto", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 3, repetivel: true, opcoes: [], nichoVinculado: "outro" },
