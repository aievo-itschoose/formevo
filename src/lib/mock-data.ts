...
export const initialBlocks: Block[] = [
  {
    ...
    perguntas: [
      ...
      { id: "ident-sistema-integracao", blocoId: "identificacao", texto: "Qual sistema de integração?", tipo: "TEXTO_CURTO", obrigatoria: false, ordem: 7, repetivel: false, opcoes: [] },
  ...
  },
  {
    ...
    perguntas: [
      ...
      { id: "planos-valor", blocoId: "planos", texto: "Valor", tipo: "TEXTO_CURTO", obrigatoria: true, ordem: 3, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { id: "planos-incluso", blocoId: "planos", texto: "O que está incluso", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 4, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { id: "planos-nao-incluso", blocoId: "planos", texto: "O que NÃO está incluso", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 5, repetivel: true, opcoes: [], nichoVinculado: "veicular" },
      { id: "planos-descricao-outro", blocoId: "planos", texto: "Descreva o que a empresa faz, qual solução oferece e que tipo de produto", tipo: "TEXTO_LONGO", obrigatoria: true, ordem: 3, repetivel: true, opcoes: [], nichoVinculado: "outro" },
